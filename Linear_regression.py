...
Autor: Cleverton Oliveira Dias
email para contato: cleverton.dias@gmail.com
Versão: 1.0.0
Descrição:
Programa para ajuste linear de dados experimentais pelo método
dos mínimos quadrados, determinando os coeficientes angular e
linear da reta y = ax + b.
...
b = (sum(lista_y)-(a*(sum(lista_x))))/v # coeficiente linear da reta
